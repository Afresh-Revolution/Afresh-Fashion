...
CREATE TABLE IF NOT EXISTS contact_section (
  ...
  email           TEXT NOT NULL DEFAULT 'hello@afreshfashion.com',
...
INSERT INTO contact_section (id, intro_text)
VALUES (1, 'For press, collaborations, wholesale inquiries, or just to connect with the movement.')
ON CONFLICT (id) DO NOTHING;
